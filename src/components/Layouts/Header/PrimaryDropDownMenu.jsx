...
const PrimaryDropDownMenu = ({ setTogglePrimaryDropDown, user }) => {
  ...
  return (
    <div className="absolute w-60 left-[0rem] ml-2 top-9 bg-white shadow-2xl rounded flex-col text-sm">
      {user.role === "admin" && (
        <Link
        ...
        >
          <span className="text-primary-blue">
            <DashboardIcon sx={{ fontSize: "18px", color: "#24292e" }} />
          </span>
          Admin Dashboard
        </Link>
      )}
      ...
      >
        <span className="text-primary-blue">
          <AccountCircleIcon sx={{ fontSize: "18px", color: "#24292e" }} />
        </span>
        My Profile
      </Link>
      ...
      >
        <span className="text-primary-blue">
          <PowerSettingsNewIcon sx={{ fontSize: "18px", color: "#24292e" }} />
        </span>
        Logout
      </div>
