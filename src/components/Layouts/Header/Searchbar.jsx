...
const Searchbar = () => {
    ...
    return (
        <form onSubmit={handleSubmit} className="w-full sm:w-9/12 px-1 sm:px-4 py-[7px] flex justify-between items-center shadow-md bg-white rounded-sm overflow-hidden">
