...
const Shipping = () => {
  ...
  return (
    <>
      <MetaData title="MNFST: Shipping Details" />
            ...
            <Stepper activeStep={1}>
              <div className="w-full bg-white">
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="bg-[#24292e] w-full sm:w-1/3 my-2 py-3.5 text-sm font-medium text-white shadow hover:shadow-lg rounded-sm uppercase outline-none"
                  >
